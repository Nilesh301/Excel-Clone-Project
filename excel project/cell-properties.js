...
italics.addEventListener("click",(e) => {
    ...
    // Modification 
    cellProp.italics = !cellProp.italics; // Data change
    cell.style.fontStyle = cellProp.italics ? "italics" : "normal" ; // UI change(1)
    italics.style.backgroundColor = cellProp.italics ? activeColorProp : inactiveColorProp; //UI change(2)
})
...
function addListenerToAttachCellProperties(cell) {
    ...
    cell.addEventListener("click", (e) => {
        ...
        cell.style.fontStyle = cellProp.italics ? "italics" : "normal";
        ...
        italics.style.backgroundColor = cellProp.italics ? activeColorProp : inactiveColorProp;
